...
VALUES ('CT3', 'Informatica');

INSERT INTO tipi_prove
VALUES ('Scritto'),
       ('Orale'),
       ('Pratico');
...
VALUES (2023, '2023-2024', '2023-09-01', '2024-08-31'),
...
VALUES ('S', '11', 'Marco', 'Rossi', '2000-01-01', 'M', 'marco@email.com', 'hash1'),
...
INSERT INTO persone (ruolo, cod_persona, nome, cognome, data_nascita, sesso, email, password_hash)
VALUES ('D', '1', 'Alvise', 'Spanò', '1975-05-10', 'M', 'alvise.spano@example.com', 'hash1'),
...
VALUES ('E1', 'Matematica 1', 'Fondamenti di matematica', 1, 6, 'CT3'),
...
INSERT INTO prove (cod_prova, tipo_prova, denominazione_prova, descrizione_prova, cod_anno_accademico, peso, scadenza,
                   cod_esame, cod_docente)
VALUES ('P1', 'Scritto', E'Esame Matematico Avanzato',
        'Un esame scritto impegnativo per testare le tue abilità matematiche.', 2023, 0.5, '2024-01-01', 'E1', '1'),
       ('P2', 'Orale', E'Discussione dei Principi della Fisica',
        E'Un esame orale coinvolgente per discutere i principi della fisica.', 2023, 0.2, '2024-02-01', 'E1', '2'),
       ('P3', 'Pratico', E'Applicazione delle Teorie Matematiche',
        E'Un esame pratico che richiede l\'applicazione delle teorie matematiche.', 2023, 0.3, '2024-03-01', 'E1', '3'),

       ('P4', 'Scritto', E'Comprensione della Fisica Classica',
        E'Un esame scritto completo per valutare la comprensione della fisica classica.', 2023, 0.7, '2024-04-01', 'E2',
        '4'),
       ('P5', 'Orale', E'Discussione sui Principi della Fisica',
        E'Un esame orale coinvolgente per discutere i principi della fisica.', 2023, 0.3, '2024-05-01', 'E2', '5'),

       ('P6', 'Scritto', E'Valutazione delle Competenze Informatiche',
        E'Un esame scritto impegnativo per valutare le tue competenze informatiche.', 2023, 0.5, '2024-06-01', 'E3',
        '6'),
       ('P7', 'Orale', E'Discussione dei Concetti Informatici Fondamentali',
        E'Un esame orale coinvolgente per discutere i concetti informatici fondamentali.', 2023, 0.5, '2024-07-01',
        'E3', '7'),

       ('P8', 'Scritto', E'Comprensione dei Concetti Chimici di Base',
        E'Un esame scritto completo per valutare la comprensione dei concetti chimici di base.', 2023, 1, '2024-08-01',
        'E4', '8'),

       ('P9', 'Scritto', E'Conoscenza dell\'Ingegneria del Software',
        E'Un esame scritto impegnativo per testare la tua conoscenza dell\'ingegneria del software.', 2023, 0.6,
        '2024-09-01', 'E5', '9'),
       ('P10', 'Orale', E'Discussione dei Principi dell\'Ingegneria del Software',
        E'Un esame orale coinvolgente per discutere i principi dell\'ingegneria del software.', 2023, 0.4, '2024-10-01',
        'E5', '10'),

       ('P11', 'Scritto', E'Comprensione dei Sistemi Operativi',
        E'Un esame scritto impegnativo per testare la tua comprensione dei sistemi operativi.', 2023, 0.8, '2024-11-01',
        'E6', '1'),
       ('P12', 'Orale', E'Discussione dei Fondamenti dei Sistemi Operativi',
        E'Un esame orale coinvolgente per discutere i fondamenti dei sistemi operativi.', 2023, 0.2, '2024-12-01', 'E6',
        '2'),

       ('P13', 'Scritto', E'Comprensione dei Principi di Elettrotecnica',
        E'Un esame scritto completo per valutare la comprensione dei principi di elettrotecnica.', 2023, 0.5,
        '2024-01-01', 'E7', '3'),
       ('P14', 'Orale', E'Discussione dei Concetti di Base dell\'Elettrotecnica',
        E'Un esame orale coinvolgente per discutere i concetti di base dell\'elettrotecnica.', 2023, 0.5, '2024-02-01',
        'E7', '4'),

       ('P15', 'Scritto', E'Analisi Avanzata dei Dati',
        E'Un esame scritto impegnativo per testare le tue abilità di analisi dei dati.', 2023, 0.5, '2024-03-01', 'E8',
        '5'),
       ('P16', 'Orale', E'Discussione sui Metodi di Analisi dei Dati',
        E'Un esame orale coinvolgente per discutere i metodi di analisi dei dati.', 2023, 0.5, '2024-04-01', 'E8', '6'),

       ('P17', 'Scritto', E'Comprensione delle Reti di Calcolatori',
        E'Un esame scritto completo per valutare la comprensione delle reti di calcolatori.', 2023, 0.6, '2024-05-01',
        'E9', '7'),
       ('P18', 'Orale', E'Discussione dei Concetti Introduttivi sulle Reti di Calcolatori',
        E'Un esame orale coinvolgente per discutere i concetti introduttivi sulle reti di calcolatori.', 2023, 0.4,
        '2024-06-01', 'E9', '8'),

       ('P19', 'Scritto', E'Progettazione di Circuiti Elettronici',
        E'Un esame scritto impegnativo per testare la progettazione di circuiti elettronici.', 2023, 0.5, '2024-07-01',
        'E10', '9'),
       ('P20', 'Orale', E'Discussione sulla Progettazione dei Circuiti Elettronici',
        E'Un esame orale coinvolgente per discutere la progettazione dei circuiti elettronici.', 2023, 0.5,
        '2024-08-01', 'E10', '10');
